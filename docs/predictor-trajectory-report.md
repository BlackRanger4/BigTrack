...
Deterministic synthetic evaluation for the BigTracker predictor models. This file was regenerated from the current `tests/test_predictor_trajectory_evaluation.py` during the 2026-08-28 documentation audit.
...
| Scenario | adaptive_kalman | constant_accel_kalman | alpha_beta | kalman | history |
|---|---:|---:|---:|---:|---:|
| mixed_accel | 34.888 | 31.874 | 38.547 | 41.203 | 35.639 |
| constant_velocity | 8.636 | 12.480 | 8.440 | 9.427 | 12.145 |
| constant_acceleration | 13.083 | 15.189 | 13.366 | 10.844 | 15.767 |
| zig_zag | 28.519 | 29.181 | 31.111 | 34.110 | 29.966 |
| sine_wave | 11.708 | 11.131 | 13.082 | 11.783 | 13.440 |
| center_direct | 7.010 | 11.686 | 5.851 | 9.405 | 11.284 |
| center_orbit | 31.145 | 24.303 | 35.234 | 32.783 | 32.300 |
| random_maneuver | 11.946 | 11.909 | 14.319 | 13.106 | 14.632 |
