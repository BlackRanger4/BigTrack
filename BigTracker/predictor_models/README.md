...
All model-specific persistent data is stored under a unique metadata prefix. Every predictor must define accepted and rejected update behavior and return its retained post-update state.
